...
function hasBeenBumped(baseVersion, headVersion) {
    return (headVersion.major > baseVersion.major ||
        headVersion.minor > baseVersion.minor ||
        headVersion.patch > baseVersion.patch);
}
function run() {
    try {
        const headVersionString = core.getInput('headVer');
        const baseVersionString = core.getInput('baseVer');
        const headVersionData = headVersionString.split('.');
        const baseVersionData = baseVersionString.split('.');
        const headVersion = {
